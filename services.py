...
cors = CORS(app, resources={r"/status": {"origins": "*"}, r"/action/*": {"origins": "*"},r"/window/*": {"origins": "*"},r"/music": {"origins": "*"}})

# Allow only specific IP for CORS
#cors = CORS(app, resources={r"/status": {"origins": "http://192.168.0.204"}, r"/action/*": {"origins": "http://192.168.0.204"}, r"/window/*": {"origins": "http://192.168.0.204"}})
